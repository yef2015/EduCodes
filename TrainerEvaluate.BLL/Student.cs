...
namespace TrainerEvaluate.BLL
{
    ...
    public partial class Student
    {
        ...
        public DataSet GetDataForExport(string strWhere)
        {
            ...
            strSql.Append(" select StuName,b.Name as GenderName,IdentityNo,School,c.Name as JobTitleName,TelNo, Birthday, d.Name as NationName, FirstRecord, FirstSchool, LastRecord,LastSchool,e.Name as PoliticsStatusName, Rank, RankTime, Post+'  '+PostOptName, PostTime, Mobile, TeachNo, ManageWork, Description,stutypeName    ");
